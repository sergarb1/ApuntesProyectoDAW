...
La mayoría de los proyectos que fracasan en FP lo hacen por uno o varios de estos 7 errores.
...
**Consecuencia**: Bugs que aparecen en la demo del tribunal. Suspenso.
...
<a class="nav-box nav-box-prev" href="../05-ejemplos-reales">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">05 — Ejemplos reales</span>
</a><a class="nav-box nav-box-next" href="../07-herramientas">
