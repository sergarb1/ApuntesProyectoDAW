...
> En vez de pasar 6 meses construyendo algo perfecto que nadie quiere, construye en 2 semanas algo sencillo que puedas **probar con personas reales** y aprende de lo que te digan.
...
> **Observación**: la mayoría de proyectos que fracasan en FP lo hacen porque el alumno **no termina**, no porque la idea fuera mala. El MVP evita eso.
...
Un agente como **opencode** puede ayudarte a **definir tu MVP** si le
das tu idea principal:

- 🔍 Puede preguntarte qué features son **esenciales** vs "nice to have"
- ✂️ Puede ayudarte a **recortar** tu alcance hasta llegar al mínimo viable
- 📊 Puede comparar tu idea con **proyectos similares** y sugerir qué dejar fuera
- 💡 Puede sugerirte un **alcance realista** según tu tiempo disponible

Pero **la priorización es tuya**: la IA no sabe qué es lo más importante
para tu usuario o para la evaluación del profesor.
