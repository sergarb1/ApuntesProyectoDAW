...
Pregunta: "Si quito esta feature, ¿el usuario se va a poner furioso?"
...
Si la respuesta es "no, va a pensar que está bien enfocado" → **quítala**.
...
<a class="nav-box nav-box-prev" href="../03-definir-features">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">03 — Definir features</span>
</a><a class="nav-box nav-box-next" href="../05-ejemplos-reales">
  <span class="nav-box-dir">Siguiente →</span>
  <span class="nav-box-title">05 — Ejemplos reales</span>
</a>
</div>
