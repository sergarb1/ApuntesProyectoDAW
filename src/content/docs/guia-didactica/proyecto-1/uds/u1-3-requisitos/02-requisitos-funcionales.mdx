...
<Comparativa
  dialogos={[
    ...
    { quien: "Bien escrito", texto: "RF-001: El alumno crea tareas con nombre y fecha límite. La tarea aparece en su lista ordenada por fecha." },
  ]}
...
Respuesta: Pregúntate: 1) ¿Qué puede hacer cada usuario? 2) ¿Qué información necesito mostrar? 3) ¿Qué errores debo evitar? 4) ¿Qué necesita el usuario para trabajar?
</details>
...
<a class="nav-box nav-box-prev" href="../01-que-son-requisitos">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">01 — ¿Qué son los requisitos?</span>
</a><a class="nav-box nav-box-next" href="../03-requisitos-no-funcionales">
