...
<Comparativa
  dialogos={[
    { quien: "Mal escrito", texto: "La app debe ser rápida. (¿Qué es 'rápida'? ¿200ms? ¿5s?)" },
    { quien: "Bien escrito", texto: "RNF-001: La lista de tareas carga en menos de 2 segundos en un móvil de gama baja (Nexus 5X). Se mide con DevTools." },
  ]}
...
<a class="nav-box nav-box-prev" href="../02-requisitos-funcionales">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">02 — Requisitos funcionales</span>
</a><a class="nav-box nav-box-next" href="../04-historias-de-usuario">
  <span class="nav-box-dir">Siguiente →</span>
  <span class="nav-box-title">04 — Historias de usuario</span>
</a>
</div>
