...
### Orientación aproximada: 60/20/20

Un reparto orientativo que funciona bien en proyectos pequeños:
...
> No es una regla estricta: si tu proyecto tiene más Must que el 60%,
> quizá es demasiado ambicioso. Si tienes menos, perfecto: tendrás más
> margen para Should y Could.
...
<Comparativa
  dialogos={[
    { quien: "MoSCoW", texto: "Fácil y rápido. Clasifica en Must/Should/Could/Won't. Perfecto para tu primer proyecto." },
    { quien: "Kano", texto: "Más sofisticado. Distingue básicos, lineales y excitadores. Útil para saber qué genera satisfacción real." },
    { quien: "Valor vs esfuerzo", texto: "Visual y práctico. Si algo es alto valor y bajo esfuerzo, hazlo ya. Si es bajo valor y alto esfuerzo, ni lo mires." },
  ]}
