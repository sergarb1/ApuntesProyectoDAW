...
<Comparativa
  dialogos={[
    { quien: "Mal escrita", texto: "Como usuario, quiero un CRUD de tareas para gestionarlas. (¿Quién es 'el usuario'? ¿Qué es 'gestionar'? ¿Qué valor tiene un CRUD?)" },
    { quien: "Bien escrita", texto: "Como alumno, quiero crear tareas con nombre y fecha límite para no olvidarme de entregar trabajos. (Claro, concreto, con valor)" },
  ]}
...
## Ejemplo: HU malas vs buenas

| HU mala | Por qué falla | HU mejorada |
|---------|--------------|-------------|
| "Como usuario quiero una app bonita" | No es estimable, no es testable | "Como estudiante quiero ver mis tareas en una lista para no olvidarme de ninguna" |
| "Como admin quiero control total del sistema" | Demasiado amplio, no es small | "Como profe quiero crear y editar tareas con título y fecha de entrega" |
| "Como usuario quiero que funcione rápido" | No es testable (¿cuánto es rápido?) | "Como estudiante quiero que la app cargue en menos de 2 segundos en 3G" |
| "Como usuario quiero todo lo de Google Classroom" | Copia sin adaptar, no es negociable | "Como profe quiero asignar tareas a alumnos concretos con fecha límite" |

> 💡 **Truco**: si no puedes poner un **criterio de aceptación** claro
> a una HU, probablemente sea demasiado vaga. Desglosa o reformula.
...
<a class="nav-box nav-box-prev" href="../03-requisitos-no-funcionales">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">03 — Requisitos no funcionales</span>
</a><a class="nav-box nav-box-next" href="../05-criterios-aceptacion">
