...
> 📚 Volver al [índice de la unidad](../u1-3-requisitos) · Anterior: [03 — Requisitos no funcionales](./03-requisitos-no-funcionales) · Siguiente: [05 — Criterios de aceptación](./05-criterios-aceptacion)
