...
<Comparativa
  dialogos={[
    { quien: "Criterio vago", texto: "DADO que el usuario hace login, CUANDO mete sus datos, ENTONCES funciona. (¿Qué es 'funciona'? ¿Qué datos?)" },
    { quien: "Criterio concreto", texto: "DADO que introduzco email 'ana@test.com' y contraseña '1234', CUANDO pulso 'Entrar', ENTONCES accedo al dashboard en menos de 2 segundos." },
  ]}
