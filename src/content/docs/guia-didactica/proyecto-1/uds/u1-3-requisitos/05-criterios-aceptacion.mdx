...
<a class="nav-box nav-box-prev" href="../04-historias-de-usuario">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">04 — Historias de usuario</span>
</a><a class="nav-box nav-box-next" href="../06-priorizacion">
  <span class="nav-box-dir">Siguiente →</span>
  <span class="nav-box-title">06 — Priorización</span>
</a>
</div>
