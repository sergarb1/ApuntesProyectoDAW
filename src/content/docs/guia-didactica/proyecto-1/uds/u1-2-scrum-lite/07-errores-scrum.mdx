...
Casi todos los fracasos de SCRUM en el aula se reducen a estos 6 errores.
...
**Consecuencia**: Trabajáis sin plan, sin roles, sin reuniones. Cuando surge un problema (que siempre surge), no tenéis ni idea de por qué ni cómo resolverlo.
...
## 🔗 Si no haces esto en PI1, lo sufrirás en PI2

Los errores de SCRUM en PI1 tienen **consecuencias reales** en PI2:

| Error en PI1 | Consecuencia en PI2 |
|-------------|---------------------|
| No estimar nada | En PI2 no sabes cuándo terminarás. El cronograma de la propuesta es pura fantasía |
| No documentar mientras trabajas | La memoria de PI2 la escribes la noche antes, incompleta y sin calma |
| No hacer retrospectiva | Repites los mismos errores en PI2 pero con más complejidad |
| No usar tablero | En PI2 tienes más tareas (tests, despliegue, docs). Sin tablero es caos |
| No integrar código | En PI2 necesitas integrar frontend + backend + BD. Sin integración continua es imposible |
| No presentar en PI1 | En PI2 el tribunal espera una demo profesional. Sin práctica, el día H es un desastre |

> 💡 **PI1 es tu campo de entrenamiento.** Si en PI1 aprendes a hacer
> planning, daily y retro, en PI2 ya lo tienes como hábito. Si no,
> PI2 será el doble de difícil.
...
<a class="nav-box nav-box-prev" href="../06-estimacion">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">06 — Estimación</span>
</a><a class="nav-box nav-box-next" href="../08-template-sprint">
