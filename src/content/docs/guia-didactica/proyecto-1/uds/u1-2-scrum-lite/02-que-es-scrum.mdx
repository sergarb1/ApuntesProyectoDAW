...
## Las ceremonias (reuniones)

SCRUM tiene 4 ceremonias oficiales. Además, la mayoría de equipos añade el **refinamiento del backlog**. En "SCRUM Lite" las simplificamos:
...
No es una ceremonia oficial, pero la mayoría de equipos la añade para preparar las historias del siguiente sprint.
...
<Comparativa
  dialogos={[
    { quien: "SCRUM formal (empresas)", texto: "3 roles definidos, 4 ceremonias oficiales (+ refinamiento), velocity tracking, burndown charts, sprint de 2 semanas, product backlog refinado, definition of done estricta." },
...
<details>
<summary>¿Cuáles son las ceremonias de SCRUM?</summary>

Respuesta: Las 4 ceremonias oficiales son Sprint Planning, Daily Scrum, Sprint Review y Sprint Retrospective. Además, casi todos los equipos añaden el refinamiento del backlog.
</details>
