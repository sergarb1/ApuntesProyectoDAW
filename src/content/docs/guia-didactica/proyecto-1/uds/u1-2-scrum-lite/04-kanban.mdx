...
<details>
<summary>¿Qué son el lead time y el throughput?</summary>

Respuesta: **Lead time** = días desde que se crea una tarea hasta que se completa. **Throughput** = tareas terminadas por semana. Sirven para detectar bloqueos.
</details>
...
<a class="nav-box nav-box-prev" href="../03-sprint">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">03 — El Sprint</span>
</a><a class="nav-box nav-box-next" href="../05-user-stories">
