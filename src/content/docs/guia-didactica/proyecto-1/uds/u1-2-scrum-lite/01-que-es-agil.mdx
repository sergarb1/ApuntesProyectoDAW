...
<Comparativa
  dialogos={[
    { quien: "Waterfall", texto: "Planificas todo al principio (2 meses), construyes todo de golpe (3 meses), entregas al final. Si el cliente cambia de opinión, lo pagas." },
...
<a class="nav-box nav-box-next" href="../02-que-es-scrum">
