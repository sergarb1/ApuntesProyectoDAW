...
> 🗺️ **Estás en:** 📐 **UD 2.6 · Diagramas** → 06 · Mermaid
...
<Comparativa
  dialogos={[
    ...
    { quien: "Mermaid", texto: "Escribo 10 líneas de código. Se renderiza automáticamente. Si cambio algo, edito una línea. Se actualiza solo." },
  ]}
...
<a class="nav-box nav-box-prev" href="../05-simbolos-uml">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">05 — Símbolos UML</span>
</a><a class="nav-box nav-box-next" href="../07-herramientas-diagramas">
  <span class="nav-box-dir">Siguiente →</span>
  <span class="nav-box-title">07 — Herramientas de diagramas</span>
</a>
</div>
