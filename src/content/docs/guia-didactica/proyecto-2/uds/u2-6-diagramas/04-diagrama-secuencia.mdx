...
> 🗺️ **Estás en:** 📐 **UD 2.6 · Diagramas** → 04 · Diagrama de secuencia
...
<a class="nav-box nav-box-prev" href="../03-diagrama-er">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">03 — Diagrama ER</span>
</a><a class="nav-box nav-box-next" href="../05-simbolos-uml">
