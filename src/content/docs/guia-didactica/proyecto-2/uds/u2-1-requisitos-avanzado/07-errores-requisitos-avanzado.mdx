...
**Solución**: Detectar contradicciones en el refinamiento y **negociar** con el Product Owner cuál tiene prioridad.
...
<a class="nav-box nav-box-prev" href="../06-trazabilidad">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">06 — Trazabilidad</span>
</a><a class="nav-box nav-box-next" href="../08-template-requisitos-avanzado">
