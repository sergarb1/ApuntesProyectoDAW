...
| **UD 2.4 Testing** | Unitarios, integración, E2E | Validarás los requisitos con tests |
| **UD 2.5 Patrones de Diseño** | MVC, Repository, Observer | Implementarás los requisitos usando patrones |
| **UD 2.6 Diagramas** | C4, UML, secuencia | Modelarás la arquitectura de los requisitos |
...
<a class="nav-box nav-box-prev" href="../08-template-requisitos-avanzado">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">08 — Template avanzado</span>
</a><a class="nav-box nav-box-next" href="../../u2-2-scrum-avanzado">
  <span class="nav-box-dir">Siguiente →</span>
  <span class="nav-box-title">UD 2.2 — SCRUM Avanzado</span>
</a>
</div>
