...
Es una **orientación habitual**, no una ley. Si tu sprint tiene 100 puntos de esfuerzo:
- **60 puntos** para Must (lo imprescindible)
- **20 puntos** para Should (lo importante)
- **20 puntos** para Could (lo deseable)

**Si tus Must superan el 60%**, es una señal de alarma: probablemente el alcance es demasiado ambicioso para el sprint. Aplica la regla al **proyecto completo**, no a cada sprint por separado.
...
Satisfacción
    ↑
    │  ┌─ Excitadores: de "no importa" a "¡me encanta!"
    │  │   (su ausencia no molesta; su presencia sorprende)
    │  │
    │  ┌ Lineales: a más cumplimiento, más satisfacción
    │  │   (rendimiento, velocidad, usabilidad)
    │  │
    │  └ Básicos: sin ellos, frustración total
    │      (su presencia se da por hecho; su ausencia enfada)
    │
    └──────────────────────────────────────→ Cumplimiento
```
