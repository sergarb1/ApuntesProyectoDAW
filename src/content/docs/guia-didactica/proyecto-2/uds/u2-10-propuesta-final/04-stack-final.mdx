...
> 🗺️ **Estás en:** 🚀 **UD 2.10 · Propuesta Final** → 04 · Stack tecnológico final
...
- **Por qué Express**: Simple, flexible, mucha documentación
...
<a class="nav-box nav-box-prev" href="../03-seleccion-idea-final">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">03 — Selección</span>
</a><a class="nav-box nav-box-next" href="../05-features-finales">
