...
> 🗺️ **Estás en:** 🏗️ **UD 2.5 · Patrones de Diseño** → 04 · Patrones de comportamiento
...
<a class="nav-box nav-box-prev" href="../03-estructurales">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">03 — Patrones estructurales</span>
</a><a class="nav-box nav-box-next" href="../05-mvc">
