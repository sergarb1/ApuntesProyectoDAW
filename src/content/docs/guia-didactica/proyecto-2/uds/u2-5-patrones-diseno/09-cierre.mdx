...
|--------|---------------|-----------------|
| **UD 2.6 Diagramas** | C4, UML, secuencia | Modelarás la arquitectura que diseñaste con patrones |
| **UD 2.7 IA como Copiloto** | LLMs, prompt engineering | Usarás IA para implementar patrones en tu código |
| **UD 2.8 Despliegue** | Docker, CI/CD | Desplegarás la arquitectura que diseñaste |
