...
| Caso | Ejemplo |
|------|---------|
| Configuración global | `new Config()` (devuelve siempre la misma instancia) |
| Logger | `new Logger()` |
| Cache | `new Cache()` |
...
<a class="nav-box nav-box-prev" href="../01-que-son-patrones">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">01 — ¿Qué son los patrones?</span>
</a><a class="nav-box nav-box-next" href="../03-estructurales">
