...
// ✅ BIEN: variables de entorno (sin fallback peligroso en producción)
...
<Comparativa
  dialogos={[
    { quien: "Sin Docker", texto: "'En mi máquina funciona' - el servidor tiene Node 18, yo tengo Node 20. El profesor tiene Windows, yo tengo Mac. El despliegue falla." },
    { quien: "Con Docker", texto: "El contenedor incluye Node 20, las dependencias exactas y la configuración. Funciona igual en cualquier máquina." },
  ]}
...
<a class="nav-box nav-box-prev" href="../01-que-es-despliegue">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">01 — Qué es el despliegue</span>
</a><a class="nav-box nav-box-next" href="../03-ci-cd-despliegue">
