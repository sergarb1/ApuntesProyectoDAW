...
| **UD 2.4 Testing** | Unitarios, integración, E2E | Verificarás las historias del sprint con tests |
| **UD 2.5 Patrones de Diseño** | MVC, Repository, Observer | Implementarás las historias del sprint usando patrones |
| **UD 2.6 Diagramas** | C4, UML, secuencia | Modelarás la arquitectura que planificaste en el sprint |
| **UD 2.7 IA como Copiloto** | LLMs, prompt engineering | Usarás IA para acelerar las tareas del sprint |
