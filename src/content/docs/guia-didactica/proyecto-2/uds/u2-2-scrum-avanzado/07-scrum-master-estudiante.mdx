...
Un agente de IA como **opencode** puede ser un gran aliado del SCRUM
Master para preparar ceremonias:

- 📋 Redactar la **agenda** del sprint planning o de la retrospectiva
- 📝 Resumir la **retrospectiva** y extraer las acciones acordadas
- 🧮 Calcular **métricas** (velocidad, burndown) a partir de tus datos
- ⏰ Recordar **compromisos** y seguimiento de acciones

Pero **facilitar la conversación y mediar en conflictos es tu trabajo**:
la IA no lee las emociones del equipo ni gestiona las personas.

> 📚 Sobre prompts y agentes: [UD 2.7 — Prompts efectivos](../../u2-7-ia-copiloto/02-prompts-efectivos) y [UD 2.7 — Agentes](../../u2-7-ia-copiloto/04-agentes).
