...
> 🗺️ **Estás en:** 📊 **UD 2.8 · Monitorización** → 04 · Alertas
...
> 📚 Volver al [índice de la unidad](../u2-8-monitorizacion) · Anterior: [03 — Prometheus + Grafana](./03-prometheus-grafana) · Siguiente: [05 — Stack mínimo](./05-stack-minimo)
