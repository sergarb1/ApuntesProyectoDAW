...
> 🗺️ **Estás en:** 🤖 **UD 2.7 · IA como Copiloto** → 07 · Errores comunes
...
// ¿Qué pasa con un array vacío? → lanza TypeError (reduce sin valor inicial)
// ¿Qué pasa con [1, 2, "3"]? → reduce da "33" (concatenación, no suma), y "33"/3 = 11
```
...
<a class="nav-box nav-box-prev" href="../06-etica-ia">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">06 — Ética de la IA</span>
</a><a class="nav-box nav-box-next" href="../08-template-ia">
