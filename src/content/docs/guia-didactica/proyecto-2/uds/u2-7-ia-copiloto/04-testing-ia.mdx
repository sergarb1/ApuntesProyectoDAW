...
> 🗺️ **Estás en:** 🤖 **UD 2.7 · IA como Copiloto** → 04 · Testing con IA
...
<a class="nav-box nav-box-prev" href="../03-copilot-github">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">03 — GitHub Copilot</span>
</a><a class="nav-box nav-box-next" href="../05-seguridad-ia">
