...
<Comparativa
  dialogos={[
    { quien: "IA", texto: "Puedo generar un componente de login en 30 segundos con email, contraseña, validación y manejo de errores." },
    { quien: "Desarrollador", texto: "Puedo decidir si el login necesita OAuth, si la validación debe ser client-side o server-side, y si el error debe ser genérico o específico." },
  ]}
...
<a class="nav-box nav-box-next" href="../02-prompts-efectivos">
