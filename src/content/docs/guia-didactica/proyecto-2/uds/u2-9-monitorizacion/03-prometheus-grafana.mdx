...
> 🗺️ **Estás en:** 📊 **UD 2.9 · Monitorización** → 03 · Prometheus y Grafana
...
```yaml
# docker-compose.yml (monitorización)
# Añade tu propia app como servicio: Prometheus la scrapea en app:3000
services:
  app:
    build: .              # tu aplicación (expone /metrics)
    ports:
      - "3000:3000"
...
2. Puedes empezar con **Prometheus solo** (sin Grafana) y ver las métricas en su interfaz web
3. La alternativa más simple es un **servicio externo** como UptimeRobot o Better Stack

**Consejo**: Si quieres demostrar conocimientos avanzados, configura Docker Compose con Prometheus + Grafana. Son ~20 líneas de YAML (el Dockerfile sería el de tu propia app).
</Aclaracion>
...
<a class="nav-box nav-box-prev" href="../02-metricas">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">02 — Métricas clave</span>
</a><a class="nav-box nav-box-next" href="../04-alertas">
