...
| Erros por endpoint | Table | `topk(10, sum by (path))` |
...
Respuesta: Para que cualquier persona sepa qué se monitoriza, cómo seConsulta y qué significan los números del dashboard.
</details>
