...
> 🗺️ **Estás en:** 📊 **UD 2.9 · Monitorización** → 06 · Configuración
...
// Rutas
app.use(metricsRoutes);          // expone GET /metrics (Prometheus lo scrapea aquí)
...
<a class="nav-box nav-box-prev" href="../05-stack-minimo">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">05 — Stack mínimo</span>
</a><a class="nav-box nav-box-next" href="../07-dashboard">
