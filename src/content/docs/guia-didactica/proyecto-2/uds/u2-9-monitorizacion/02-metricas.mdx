...
> 🗺️ **Estás en:** 📊 **UD 2.9 · Monitorización** → 02 · Métricas clave
...
<Comparativa
  dialogos={[
    { quien: "Logs", texto: "Te dicen QUÉ pasó: 'Error al conectar con BD a las 10:30:45'. Útil para diagnosticar un error específico." },
    { quien: "Métricas", texto: "Te dicen CÓMO ESTÁ tu app ahora: '95% de peticiones responden en &lt;200ms'. Útil para ver tendencias y alertas." },
  ]}
...
<a class="nav-box nav-box-prev" href="../01-que-son-logs">
  <span class="nav-box-dir">← Anterior</span>
  <span class="nav-box-title">01 — Qué son los logs</span>
</a><a class="nav-box nav-box-next" href="../03-prometheus-grafana">
